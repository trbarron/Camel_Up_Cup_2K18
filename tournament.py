...
# Core game-running logic and the bot registry live in tournament_core (no
# display deps) so the leaderboard Lambda can import them without rich.
from tournament_core import (  # noqa: F401 — re-exported
    ACTION_MAP, _KNOWN_BOTS, BOT_REGISTRY, init_stats, run_game,
)
...
BOT_COLORS = {
    ...
    "tb-Player1":        "green",
    "tb-Player2":        "yellow",
    "tb-HandcodedHenry": "magenta",
    "tb-ClaudeCamel":    "bold red",
